...
class CountyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var birdsTableVC:BirdsTableViewController = BirdsTableViewController()
        birdsTableVC.county = State.counties[indexPath.row]
        self.navigationController?.pushViewController(birdsTableVC, animated: true)
    }
